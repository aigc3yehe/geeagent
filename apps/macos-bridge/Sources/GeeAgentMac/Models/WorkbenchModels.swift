...
struct WorkbenchInteractionCapabilities: Hashable {
    ...
    /// Gate for the menu-bar quick-input panel. Mirrors the Rust runtime's
...
/// Mirrors `experience_registry::ModuleDisplayMode` / `display_mode` on
/// `InstalledAppSummary` in the Rust workspace snapshot.
