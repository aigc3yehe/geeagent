...
struct PreviewWorkbenchRuntimeClient: WorkbenchRuntimeClient {
    func loadSnapshot() -> WorkbenchSnapshot {
        let previewApps = GearRegistry.mergedWithGears([
            InstalledAppRecord(
        ...
        return WorkbenchSnapshot(
            ...
            homeItems: [
                ...
                WorkbenchHomeItem(
                    ...
                    title: "Resolve macOS bridge verify failure",
                    detail: "The bridge build is blocked on a failing verification step.",
                    statusLabel: "Blocked",
            ...
            tasks: [
                ...
                WorkbenchTaskRecord(
                    id: "task-bridge-verify",
                    title: "Repair macOS bridge verification",
                    ...
                    artifactCount: 2,
                    moduleRunID: "module-run-bridge-verify",
                    canRetry: true
                ),
                WorkbenchTaskRecord(
